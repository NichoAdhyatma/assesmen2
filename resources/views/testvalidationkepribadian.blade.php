...
<head>
    ...
    <title>Tes Validasi Kepribadian</title>
    <style>
        body {
...
<body>
    <div class="container">
        <ol id="question-list">
            <li class="question">
                <h1>Question 1:</h1>
                <p>Saya memiliki keinginan kuat untuk menjadi pemimpin dan mengambil inisiatif.</p>
            ...
            <li class="question">
                <h1>Question 2:</h1>
                <p>Saya cenderung bersikap ramah dan murah hati terhadap orang lain.</p>
                <div class="answer-form">
                    <form class="answer-form">
                        <label class="radio-label">
                            <input type="radio" class="radio-input" name="answer1" value="1">
            ...
            <li class="question">
                <h1>Question 3:</h1>
                <p>Saya sering merasa cemas dan khawatir.</p>
                <div class="answer-form">
                    <form class="answer-form">
                        <label class="radio-label">
                            <input type="radio" class="radio-input" name="answer1" value="1">
            ...
            <li class="question">
                <h1>Question 4:</h1>
                <p>Saya mudah marah dan sulit untuk mengendalikan emosi negatif saya.</p>
                <div class="answer-form">
                    <form class="answer-form">
                        <label class="radio-label">
                            <input type="radio" class="radio-input" name="answer1" value="1">
            ...
            <li class="question">
                <h1>Question 5:</h1>
                <p>Saya memiliki rasa ingin tahu yang besar dan selalu ingin belajar hal-hal baru.</p>
                <div class="answer-form">
                    <form class="answer-form">
                        <label class="radio-label">
                            <input type="radio" class="radio-input" name="answer1" value="1">
