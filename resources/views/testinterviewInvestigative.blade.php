...
<body>
    ...
    <div class="contact--lockup">
        ...
        <video id="main-video" controls style="width: 100%; height: 65vh;">
            <source src="{{ asset('assets/video/Investigative/' . $randomVideo) }}" type="video/mp4">
        ...
        <div class="col-12 col-md-6">
            ...
            <a href="{{ route('testinterviewArtistic') }}" class="special-link-button">
                        ...
                        if (response && response.data) {
                            ...
                            for (var key in jsonData) {
                                if (jsonData.hasOwnProperty(key)) {
                                    var sessionName = key + "Investigative";
