...
<body>
    ...
    <!-- </div> -->
    <p> Jawablah pertanyaan dari set soal yang diberikan. Maksimum dalam menjawab pertnyaan adalah 30 menit.</p>
    <div class="contact--lockup">
        <div id="video-container-" style="height:100%; width:100%; padding-top:150px">
            ...
            <video controls autoplay style="width: 100%; height: 65vh;">
                <source src="assets/video/InstructionCognitiveVideo.mp4" type="video/mp4">
