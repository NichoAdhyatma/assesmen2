...
<body>
    ...
    <div class="contact--lockup">
        ...
        @php
            $videoDir = public_path('assets/video/Social'); // Specify the path to your video folder.
        ...
        <video id="main-video" controls autoplay style="width: 100%; height: 65vh;">
            <source src="{{ asset('assets/video/Social' . $randomVideo) }}" type="video/mp4">
            ...
            <a href="{{ route('testinterviewEnterprising') }}" class="special-link-button">
