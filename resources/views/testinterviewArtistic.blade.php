...
<body>
    ...
    <div class="contact--lockup">
        ...
        @php
            $videoDir = public_path('assets/video/Artistic'); // Specify the path to your video folder.
        ...
        <video id="main-video" controls autoplay style="width: 100%; height: 65vh;">
            <source src="{{ asset('assets/video/Artistic/' . $randomVideo) }}" type="video/mp4">
            ...
            <a href="{{ route('testinterviewSocial') }}" class="special-link-button">
