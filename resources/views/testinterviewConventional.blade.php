...
<body>
    ...
    <div class="contact--lockup">
        ...
        @php
            $videoDir = public_path('assets/video/Conventional'); // Specify the path to your video folder.
        ...
        <video id="main-video" controls autoplay style="width: 100%; height: 65vh;">
            <source src="{{ asset('assets/video/Conventional' . $randomVideo) }}" type="video/mp4">
            ...
            <a href="{{ route('testinterviewPerseptual') }}" class="special-link-button">
                        ...
                        if (response && response.data) {
                            ...
                            for (var key in jsonData) {
                                if (jsonData.hasOwnProperty(key)) {
                                    var sessionName = key + "Conventional";
