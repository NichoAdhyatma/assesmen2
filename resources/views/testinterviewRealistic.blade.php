...
<body>
    ...
    <div class="contact--lockup">
        ...
        @php
            $videoDir = public_path('assets/video/Realistic'); // Specify the path to your video folder.
        ...
        <video id="main-video" controls style="width: 100%; height: 65vh;">
            <source src="{{ asset('assets/video/Realistic/' . $randomVideo) }}" type="video/mp4">
        ...
        <div class="col-12 col-md-6">
            ...
            <a href="{{ route('testinterviewInvestigative') }}" class="special-link-button">
