...
<body>
    ...
    <div class="contact--lockup">
        ...
        @php
            $videoDir = public_path('assets/video/Intelektual'); // Specify the path to your video folder.
                        ...
                        if (response && response.data) {
                            ...
                            for (var key in jsonData) {
                                if (jsonData.hasOwnProperty(key)) {
                                    var sessionName = key + "Intelektual";
