...
<body>
    <div class="container">
        <ol id="question-list">
            <li class="question">
                <h1>Question:</h1>
                    <div class="question-image-container">
                        <img src="assets/InteligenceSet/Set1/questionImg/Mudah1.png" alt="Question 1" class="image">
                    </div>
            ...
            <li class="question">
                <h1>Question:</h1>
                    <div class="question-image-container">
                        <img src="assets/InteligenceSet/Set1/questionImg/Mudah2.png" alt="Question 1" class="image">
                    </div>
                <div class="answer-form">
                    <form class="answer-form">
                        <label class="radio-label" data-correct="true">
            ...
            <li class="question">
                <h1>Question:</h1>
                    <div class="question-image-container">
                        <img src="assets/InteligenceSet/Set1/questionImg/Mudah3.png" alt="Question 1" class="image">
                    </div>
                <div class="answer-form">
                    <form class="answer-form">
                        <label class="radio-label" data-correct="true">
            ...
            <li class="question">
                <h1>Question:</h1>
                    <div class="question-image-container">
                        <img src="assets/InteligenceSet/Set1/questionImg/Mudah4.png" alt="Question 1" class="image">
                    </div>
                <div class="answer-form">
                    <form class="answer-form">
                        <label class="radio-label" data-correct="true">
            ...
            <li class="question">
                <h1>Question:</h1>
                    <div class="question-image-container">
                        <img src="assets/InteligenceSet/Set1/questionImg/Mudah5.png" alt="Question 1" class="image">
                    </div>
                <div class="answer-form">
                    <form class="answer-form">
                        <label class="radio-label" data-correct="true">
            ...
            <li class="question">
                <h1>Question:</h1>
                    <div class="question-image-container">
                        <img src="assets/InteligenceSet/Set1/questionImg/Mudah6.png" alt="Question 1" class="image">
                    </div>
                <div class="answer-form">
                    <form class="answer-form">
                        <label class="radio-label" data-correct="true">
            ...
            <li class="question">
                <h1>Question:</h1>
                    <div class="question-image-container">
                        <img src="assets/InteligenceSet/Set1/questionImg/Mudah7.png" alt="Question 1" class="image">
                    </div>
                <div class="answer-form">
                    <form class="answer-form">
                        <label class="radio-label" data-correct="true">
            ...
            <li class="question">
                <h1>Question:</h1>
                    <div class="question-image-container">
                        <img src="assets/InteligenceSet/Set1/questionImg/Mudah8.png" alt="Question 1" class="image">
                    </div>
                <div class="answer-form">
                    <form class="answer-form">
                        <label class="radio-label" data-correct="true">
            ...
            <li class="question">
                <h1>Question:</h1>
                    <div class="question-image-container">
                        <img src="assets/InteligenceSet/Set1/questionImg/Mudah9.png" alt="Question 1" class="image">
                    </div>
                <div class="answer-form">
                    <form class="answer-form">
                        <label class="radio-label" data-correct="true">
                            <input type="radio" class="radio-input" name="answer1" value="Option A">
                            Polisi, polisi laki-laki, polisi wanita
                        </label>
                        <label class="radio-label">
                            <input type="radio" class="radio-input" name="answer1" value="Option B">
                            Manusia, hewan, jantan
                        </label>
                        <label class="radio-label">
                            <input type="radio" class="radio-input" name="answer1" value="Option C">
                            Komputer, handphone, laptop
                        </label>
                        <label class="radio-label">
                            <input type="radio" class="radio-input" name="answer1" value="Option D">
                            Sapi, kambing, ular
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            submitButton.addEventListener('click', function(event) {
                ...
                const skorValidasiCognitif = (parseInt(rawScore, 10) * 1) + skor2;
    ...
    <script>
         function calculateAndLogSkor() {
            ...
            // Assuming 'skor' is already defined, add the parsed rawScore to it
            const skorValidasiCognitif = parseInt(skor2, 10) + rawScore;
