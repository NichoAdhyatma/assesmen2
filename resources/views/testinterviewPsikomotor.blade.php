...
<body>
    ...
    <div class="contact--lockup">
        ...
        @php
            $videoDir = public_path('assets/video/Psikomotor'); // Specify the path to your video folder.
        ...
        <video id="main-video" controls autoplay style="width: 100%; height: 65vh;">
            ...
            <a href="{{ route('testinterviewIntelektual') }}" class="special-link-button">
                        ...
                        if (response && response.data) {
                            ...
                            for (var key in jsonData) {
                                if (jsonData.hasOwnProperty(key)) {
                                    var sessionName = key + "Psikomotor";
